...
public class TrackerDataPoolFactory {
	...
	/** DB commit order. */
	private static final String[] commitOrder = new String[]{"TrackerAttachments", "TrackerReminders", "TrackerRelated", "TrackerNotifications", "TrackerHistory", "TrackerDependencies", "TrackerComments", "TrackerCache", "TrackerAssigned", "TrackerAdminRequests", "TrackerVotes", "TrackerUsersInGroups", "TrackerTasks", "TrackerListVersion", "TrackerListTasktype", "TrackerListStatus", "TrackerListResolution", "TrackerListOs", "TrackerListCategory", "TrackerGroups", "TrackerSearches", "TrackerProjects", "TrackerUsers", "TrackerRegistrations", "TrackerPrefs", "TrackerNotificationRecipients", "TrackerNotificationMessages", "TrackerCity"};
	static{

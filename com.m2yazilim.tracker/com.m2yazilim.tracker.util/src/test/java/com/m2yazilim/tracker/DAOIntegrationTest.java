...
public class DAOIntegrationTest {
	...
	public void testPreCleanDBFirstPass() {
		...
		try{HibernateTrackerDaoFactory.getTrackerAssignedOldDao().getQuery("delete from TrackerAssignedOld").executeUpdate(); } catch (Exception e) { /* do nothing */ }
		...
		try{HibernateTrackerDaoFactory.getTrackerUserSessionDao().getQuery("delete from TrackerUserSession").executeUpdate(); } catch (Exception e) { /* do nothing */ }
		try{HibernateTrackerDaoFactory.getTrackerUserMobileSettingDao().getQuery("delete from TrackerUserMobileSetting").executeUpdate(); } catch (Exception e) { /* do nothing */ }
		try{HibernateTrackerDaoFactory.getTrackerUserLocationLogDao().getQuery("delete from TrackerUserLocationLog").executeUpdate(); } catch (Exception e) { /* do nothing */ }
		...
		try{HibernateTrackerDaoFactory.getTrackerTableChangeLogDao().getQuery("delete from TrackerTableChangeLog").executeUpdate(); } catch (Exception e) { /* do nothing */ }
		...
		try{HibernateTrackerDaoFactory.getTrackerLocationGetTypeDao().getQuery("delete from TrackerLocationGetType").executeUpdate(); } catch (Exception e) { /* do nothing */ }
	...
	public void testPreCleanDBFinalPass() {
		...
		HibernateTrackerDaoFactory.getTrackerAssignedOldDao().getQuery("delete from TrackerAssignedOld").executeUpdate();
		...
		HibernateTrackerDaoFactory.getTrackerUserSessionDao().getQuery("delete from TrackerUserSession").executeUpdate();
		HibernateTrackerDaoFactory.getTrackerUserMobileSettingDao().getQuery("delete from TrackerUserMobileSetting").executeUpdate();
		HibernateTrackerDaoFactory.getTrackerUserLocationLogDao().getQuery("delete from TrackerUserLocationLog").executeUpdate();
		...
		HibernateTrackerDaoFactory.getTrackerTableChangeLogDao().getQuery("delete from TrackerTableChangeLog").executeUpdate();
		...
		HibernateTrackerDaoFactory.getTrackerLocationGetTypeDao().getQuery("delete from TrackerLocationGetType").executeUpdate();
	...
	/**
	 * Hibernate test case for table: tracker.tracker_assigned_old.
	 * @throws CloneNotSupportedException on clone error
	 */
	@Transactional
	@Test		
	public void testTrackerAssignedOld() throws CloneNotSupportedException {

	 	DataLayerTracker dataLayerTracker = DataLayerTrackerImpl.getInstance();
		TrackerAssignedOld trackerAssignedOld = TrackerDataPoolFactory.getTrackerAssignedOld();
		dataLayerTracker.saveOrUpdate(trackerAssignedOld);

		Integer trackerAssignedOldId = trackerAssignedOld.getId();
		TrackerAssignedOld copy = trackerAssignedOld.clone();
		dataLayerTracker.flushSession(); // flush+evict from cache to make sure we hit the DB next 
		dataLayerTracker.evict(trackerAssignedOld); 		 

		trackerAssignedOld = dataLayerTracker.getTrackerAssignedOld(trackerAssignedOldId); 	// load it again
		...
		Assert.assertEquals(copy.getAssigned().getId(), trackerAssignedOld.getAssigned().getId());
		Assert.assertEquals(copy.getCreateDate().getTime() / 1000, trackerAssignedOld.getCreateDate().getTime() / 1000);
		Assert.assertEquals(copy.getIsSent(), trackerAssignedOld.getIsSent());
		Assert.assertEquals(copy.getOldUser().getId(), trackerAssignedOld.getOldUser().getId());
		Assert.assertEquals(copy.getSentDate().getTime() / 1000, trackerAssignedOld.getSentDate().getTime() / 1000);
		Assert.assertEquals(copy.getTask().getId(), trackerAssignedOld.getTask().getId());
		// tests for coverage completeness
		Assert.assertFalse(trackerAssignedOld.toString().equals(""));
		Assert.assertEquals(copy, copy.clone());
		// symmetric equality check
		Assert.assertEquals(copy.clone(), copy);
		// reflexive equality check
		Assert.assertEquals(copy, copy);
		// hashcode on identical object should return same number
		Assert.assertEquals(trackerAssignedOld.hashCode(), copy.hashCode());  
		Assert.assertNotSame(copy, 0L);
	  // End of table
	}
	/**
	...
	/**
	 * Hibernate test case for table: tracker.tracker_location_get_type.
	 * @throws CloneNotSupportedException on clone error
	 */
	@Transactional
	@Test		
	public void testTrackerLocationGetType() throws CloneNotSupportedException {

	 	DataLayerTracker dataLayerTracker = DataLayerTrackerImpl.getInstance();
		TrackerLocationGetType trackerLocationGetType = TrackerDataPoolFactory.getTrackerLocationGetType();
		dataLayerTracker.saveOrUpdate(trackerLocationGetType);

		Integer trackerLocationGetTypeId = trackerLocationGetType.getId();
		TrackerLocationGetType copy = trackerLocationGetType.clone();
		dataLayerTracker.flushSession(); // flush+evict from cache to make sure we hit the DB next 
		dataLayerTracker.evict(trackerLocationGetType); 		 

		trackerLocationGetType = dataLayerTracker.getTrackerLocationGetType(trackerLocationGetTypeId); 	// load it again
		...
		Assert.assertEquals(copy.getDescription(), trackerLocationGetType.getDescription());
		Assert.assertEquals(copy.getName(), trackerLocationGetType.getName());
		Assert.assertEquals(copy.getVersion(), trackerLocationGetType.getVersion());
		// tests for coverage completeness
		Assert.assertFalse(trackerLocationGetType.toString().equals(""));
		Assert.assertEquals(copy, copy.clone());
		// symmetric equality check
		Assert.assertEquals(copy.clone(), copy);
		// reflexive equality check
		Assert.assertEquals(copy, copy);
		// hashcode on identical object should return same number
		Assert.assertEquals(trackerLocationGetType.hashCode(), copy.hashCode());  
		Assert.assertNotSame(copy, 0L);
	  // End of table
	}
	/**
	...
	/**
	 * Hibernate test case for table: tracker.tracker_table_change_log.
	 * @throws CloneNotSupportedException on clone error
	 */
	@Transactional
	@Test		
	public void testTrackerTableChangeLog() throws CloneNotSupportedException {

	 	DataLayerTracker dataLayerTracker = DataLayerTrackerImpl.getInstance();
		TrackerTableChangeLog trackerTableChangeLog = TrackerDataPoolFactory.getTrackerTableChangeLog();
		dataLayerTracker.saveOrUpdate(trackerTableChangeLog);

		Integer trackerTableChangeLogId = trackerTableChangeLog.getId();
		TrackerTableChangeLog copy = trackerTableChangeLog.clone();
		dataLayerTracker.flushSession(); // flush+evict from cache to make sure we hit the DB next 
		dataLayerTracker.evict(trackerTableChangeLog); 		 

		trackerTableChangeLog = dataLayerTracker.getTrackerTableChangeLog(trackerTableChangeLogId); 	// load it again
		...
		Assert.assertEquals(copy.getCreateDate().getTime() / 1000, trackerTableChangeLog.getCreateDate().getTime() / 1000);
		Assert.assertEquals(copy.getIsSent(), trackerTableChangeLog.getIsSent());
		Assert.assertEquals(copy.getSentDate().getTime() / 1000, trackerTableChangeLog.getSentDate().getTime() / 1000);
		Assert.assertEquals(copy.getTableName(), trackerTableChangeLog.getTableName());
		Assert.assertEquals(copy.getTableRowId(), trackerTableChangeLog.getTableRowId());
		// tests for coverage completeness
		Assert.assertFalse(trackerTableChangeLog.toString().equals(""));
		Assert.assertEquals(copy, copy.clone());
		// symmetric equality check
		Assert.assertEquals(copy.clone(), copy);
		// reflexive equality check
		Assert.assertEquals(copy, copy);
		// hashcode on identical object should return same number
		Assert.assertEquals(trackerTableChangeLog.hashCode(), copy.hashCode());  
		Assert.assertNotSame(copy, 0L);
	  // End of table
	}
	/**
	...
	/**
	 * Hibernate test case for table: tracker.tracker_user_location_log.
	 * @throws CloneNotSupportedException on clone error
	 */
	@Transactional
	@Test		
	public void testTrackerUserLocationLog() throws CloneNotSupportedException {

	 	DataLayerTracker dataLayerTracker = DataLayerTrackerImpl.getInstance();
		TrackerUserLocationLog trackerUserLocationLog = TrackerDataPoolFactory.getTrackerUserLocationLog();
		dataLayerTracker.saveOrUpdate(trackerUserLocationLog);

		Integer trackerUserLocationLogId = trackerUserLocationLog.getId();
		TrackerUserLocationLog copy = trackerUserLocationLog.clone();
		dataLayerTracker.flushSession(); // flush+evict from cache to make sure we hit the DB next 
		dataLayerTracker.evict(trackerUserLocationLog); 		 

		trackerUserLocationLog = dataLayerTracker.getTrackerUserLocationLog(trackerUserLocationLogId); 	// load it again
		...
		Assert.assertEquals(copy.getCreateDate(), trackerUserLocationLog.getCreateDate());
		Assert.assertEquals(copy.getDeviationShare(), trackerUserLocationLog.getDeviationShare());
		Assert.assertEquals(copy.getLatitude(), trackerUserLocationLog.getLatitude());
		Assert.assertEquals(copy.getLocationGetType().getId(), trackerUserLocationLog.getLocationGetType().getId());
		Assert.assertEquals(copy.getLongitude(), trackerUserLocationLog.getLongitude());
		Assert.assertEquals(copy.getUser().getId(), trackerUserLocationLog.getUser().getId());
		// tests for coverage completeness
		Assert.assertFalse(trackerUserLocationLog.toString().equals(""));
		Assert.assertEquals(copy, copy.clone());
		// symmetric equality check
		Assert.assertEquals(copy.clone(), copy);
		// reflexive equality check
		Assert.assertEquals(copy, copy);
		// hashcode on identical object should return same number
		Assert.assertEquals(trackerUserLocationLog.hashCode(), copy.hashCode());  
		Assert.assertNotSame(copy, 0L);
	  // End of table
	}
	/**
	 * Hibernate test case for table: tracker.tracker_user_mobile_setting.
	 * @throws CloneNotSupportedException on clone error
	 */
	@Transactional
	@Test		
	public void testTrackerUserMobileSetting() throws CloneNotSupportedException {

	 	DataLayerTracker dataLayerTracker = DataLayerTrackerImpl.getInstance();
		TrackerUserMobileSetting trackerUserMobileSetting = TrackerDataPoolFactory.getTrackerUserMobileSetting();
		dataLayerTracker.saveOrUpdate(trackerUserMobileSetting);

		Integer trackerUserMobileSettingId = trackerUserMobileSetting.getId();
		TrackerUserMobileSetting copy = trackerUserMobileSetting.clone();
		dataLayerTracker.flushSession(); // flush+evict from cache to make sure we hit the DB next 
		dataLayerTracker.evict(trackerUserMobileSetting); 		 

		trackerUserMobileSetting = dataLayerTracker.getTrackerUserMobileSetting(trackerUserMobileSettingId); 	// load it again
		...
		Assert.assertEquals(copy.getCoordinatPostInterval(), trackerUserMobileSetting.getCoordinatPostInterval());
		Assert.assertEquals(copy.getIsSentLocation(), trackerUserMobileSetting.getIsSentLocation());
		Assert.assertEquals(copy.getLocationGetType().getId(), trackerUserMobileSetting.getLocationGetType().getId());
		Assert.assertEquals(copy.getUser().getId(), trackerUserMobileSetting.getUser().getId());
		Assert.assertEquals(copy.getVersion(), trackerUserMobileSetting.getVersion());
		// tests for coverage completeness
		Assert.assertFalse(trackerUserMobileSetting.toString().equals(""));
		Assert.assertEquals(copy, copy.clone());
		// symmetric equality check
		Assert.assertEquals(copy.clone(), copy);
		// reflexive equality check
		Assert.assertEquals(copy, copy);
		// hashcode on identical object should return same number
		Assert.assertEquals(trackerUserMobileSetting.hashCode(), copy.hashCode());  
		Assert.assertNotSame(copy, 0L);
	  // End of table
	}
	/**
	...
	/**
	 * Hibernate test case for table: tracker.tracker_user_session.
	 * @throws CloneNotSupportedException on clone error
	 */
	@Transactional
	@Test		
	public void testTrackerUserSession() throws CloneNotSupportedException {

	 	DataLayerTracker dataLayerTracker = DataLayerTrackerImpl.getInstance();
		TrackerUserSession trackerUserSession = TrackerDataPoolFactory.getTrackerUserSession();
		dataLayerTracker.saveOrUpdate(trackerUserSession);

		Integer trackerUserSessionId = trackerUserSession.getId();
		TrackerUserSession copy = trackerUserSession.clone();
		dataLayerTracker.flushSession(); // flush+evict from cache to make sure we hit the DB next 
		dataLayerTracker.evict(trackerUserSession); 		 

		trackerUserSession = dataLayerTracker.getTrackerUserSession(trackerUserSessionId); 	// load it again
		...
		Assert.assertEquals(copy.getCreateDate(), trackerUserSession.getCreateDate());
		Assert.assertEquals(copy.getDeviceRegisterKey(), trackerUserSession.getDeviceRegisterKey());
		Assert.assertEquals(copy.getExpireDate(), trackerUserSession.getExpireDate());
		Assert.assertEquals(copy.getToken(), trackerUserSession.getToken());
		Assert.assertEquals(copy.getUpdateDate(), trackerUserSession.getUpdateDate());
		Assert.assertEquals(copy.getUser().getId(), trackerUserSession.getUser().getId());
		// tests for coverage completeness
		Assert.assertFalse(trackerUserSession.toString().equals(""));
		Assert.assertEquals(copy, copy.clone());
		// symmetric equality check
		Assert.assertEquals(copy.clone(), copy);
		// reflexive equality check
		Assert.assertEquals(copy, copy);
		// hashcode on identical object should return same number
		Assert.assertEquals(trackerUserSession.hashCode(), copy.hashCode());  
		Assert.assertNotSame(copy, 0L);
	  // End of table
	}
	/**
